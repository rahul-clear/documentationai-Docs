...
| Guest User              | This role provides limited access for external users to perform specific actions  without full access to e-Invoicing data.                                                                       |
| Guest View Only         | This role provides external users with view access to, without the ability to take any action or upload data in e-Invoicing.                                                                     |
